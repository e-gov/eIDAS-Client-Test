...
public class ResponseBuilderUtils extends ResponseAssertionBuilderUtils {
    ...
    public Response buildAuthnResponse(Credential signCredential, Credential encCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            ...
            authnResponse.getEncryptedAssertions().add(buildEncrAssertion(signCredential, encCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
    ...
    public Response buildAuthnResponseWithMaxAttributes(Credential signCredential, Credential encCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String birthName, String birthNameFamily, String birthPlace, String address, String gender, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            Signature signature = prepareSignature(signCredential);
            DateTime timeNow = new DateTime();
            Response authnResponse = buildResponseForSigningWithoutAssertion(inResponseId, recipient, timeNow, issuerValue, issuerFormat);
            authnResponse.getEncryptedAssertions().add(buildEncrAssertionWithMaxAttributes(signCredential, encCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, birthName, birthNameFamily, birthPlace, address, gender, issuerValue, issuerFormat, audienceUri));
            authnResponse.setSignature(signature);
            XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(authnResponse).marshall(authnResponse);
            Signer.signObject(signature);
            return authnResponse;
    ...
    public Response buildAuthnResponseWithUnsignedAssertions(Credential signCredential, Credential encCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            ...
            DateTime timeNow = new DateTime();
            Response authnResponse = buildResponseForSigningWithoutAssertion(inResponseId, recipient, timeNow, issuerValue, issuerFormat);
            authnResponse.getEncryptedAssertions().add(buildEncrAssertionWithoutAssertionSignature(encCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
            authnResponse.setSignature(signature);
            XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(authnResponse).marshall(authnResponse);
            Signer.signObject(signature);
            return authnResponse;
    ...
    public Response buildAuthnResponseWithoutEncryption(Credential signCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            Signature signature = prepareSignature(signCredential);
            DateTime timeNow = new DateTime();
            Response authnResponse = buildResponseForSigningWithoutAssertion(inResponseId, recipient, timeNow, issuerValue, issuerFormat);
            authnResponse.getAssertions().add(buildAssertionWithoutEncryption(signCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
            authnResponse.setSignature(signature);
            XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(authnResponse).marshall(authnResponse);
            Signer.signObject(signature);
            return authnResponse;
    ...
    public Response buildAuthnResponseWithMultipleAssertions(Credential signCredential, Credential encCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            Signature signature = prepareSignature(signCredential);
            DateTime timeNow = new DateTime();
            Response authnResponse = buildResponseForSigningWithoutAssertion(inResponseId, recipient, timeNow, issuerValue, issuerFormat);
            authnResponse.getEncryptedAssertions().add(buildEncrAssertion(signCredential, encCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
            authnResponse.getEncryptedAssertions().add(buildEncrAssertion(signCredential, encCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName + "1", familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
            authnResponse.setSignature(signature);
            XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(authnResponse).marshall(authnResponse);
            Signer.signObject(signature);
            return authnResponse;
    ...
    public Response buildAuthnResponseWithMultipleStatusCode(Credential signCredential, Credential encCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, Integer statusCodeCnt, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            Signature signature = prepareSignature(signCredential);
            DateTime timeNow = new DateTime();
            Response authnResponse = buildResponseForSigningWithoutAssertion(inResponseId, recipient, timeNow, issuerValue, issuerFormat);
    ...
    public Response buildAuthnResponseWithoutNameID(Credential signCredential, Credential encCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            ...
            DateTime timeNow = new DateTime();
            Response authnResponse = buildResponseForSigningWithoutAssertion(inResponseId, recipient, timeNow, issuerValue, issuerFormat);
            authnResponse.getEncryptedAssertions().add(buildEncrAssertionWithoutNameId(signCredential, encCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
            XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(authnResponse).marshall(authnResponse);
            authnResponse.setSignature(signature);
            Signer.signObject(signature);
            return authnResponse;
    ...
    public Response buildAuthnResponseWithWrongNameFormat(Credential signCredential, Credential encCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            ...
            DateTime timeNow = new DateTime();
            Response authnResponse = buildResponseForSigningWithoutAssertion(inResponseId, recipient, timeNow, issuerValue, issuerFormat);
            authnResponse.getEncryptedAssertions().add(buildEncrAssertionWithWrongNameFormat(signCredential, encCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
            XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(authnResponse).marshall(authnResponse);
            authnResponse.setSignature(signature);
            Signer.signObject(signature);
            return authnResponse;
    ...
    public Response buildAuthnResponseWithError(Credential signCredential, String inResponseId, String recipient, String error, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            Signature signature = prepareSignature(signCredential);
            DateTime timeNow = new DateTime();
            ...
            authnResponse.getAssertions().add(buildAssertion(inResponseId,recipient, timeNow, acceptableTimeMin, null, "EE/EE/33232", issuerValue, issuerFormat, audienceUri));
    ...
    public Response buildAuthnResponseWithInResponseTo(Credential signCredential, Credential encCredential, String inResponseIdResponse, String inResponseIdSubject, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            ...
            authnResponse.getEncryptedAssertions().add(buildEncrAssertion(signCredential, encCredential, inResponseIdSubject, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
            authnResponse.setSignature(signature);
            XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(authnResponse).marshall(authnResponse);
            Signer.signObject(signature);
            return authnResponse;
    ...
    public Response buildAuthnResponseWithAuthnStatement(Integer cnt, Credential signCredential, Credential encCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            ...
            DateTime timeNow = new DateTime();
            Response authnResponse = buildResponseForSigningWithoutAssertion(inResponseId, recipient, timeNow, issuerValue, issuerFormat);
            authnResponse.getEncryptedAssertions().add(buildEncrAssertionWithAuthnStatementCnt(cnt, signCredential, encCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
            authnResponse.setSignature(signature);
            XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(authnResponse).marshall(authnResponse);
            Signer.signObject(signature);
            return authnResponse;
    ...
    public Response buildAuthnResponseWithAttributeStatementCnt(Integer attributeCnt, Credential signCredential, Credential encCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            ...
            DateTime timeNow = new DateTime();
            Response authnResponse = buildResponseForSigningWithoutAssertion(inResponseId, recipient, timeNow, issuerValue, issuerFormat);
            authnResponse.getEncryptedAssertions().add(buildEncrAssertionWithAttributeCnt(attributeCnt, signCredential, encCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
            authnResponse.setSignature(signature);
            XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(authnResponse).marshall(authnResponse);
            Signer.signObject(signature);
            return authnResponse;
    ...
    public Response buildAuthnResponseWithoutSubject(Credential signCredential, Credential encCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            Signature signature = prepareSignature(signCredential);
            DateTime timeNow = new DateTime();
            Response authnResponse = buildResponseForSigningWithoutAssertion(inResponseId, recipient, timeNow, issuerValue, issuerFormat);
            authnResponse.getEncryptedAssertions().add(buildEncrAssertionWithoutSubject(signCredential, encCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
            authnResponse.setSignature(signature);
            XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(authnResponse).marshall(authnResponse);
            Signer.signObject(signature);
            return authnResponse;
    ...
    public Response buildAuthnResponseWithAuthnContextCnt(Integer cnt, Credential signCredential, Credential encCredential, String inResponseId, String recipient, String loa, String givenName, String familyName, String personIdentifier, String dateOfBirth, String issuerValue, String issuerFormat, Integer acceptableTimeMin, String audienceUri) {
        try {
            ...
            DateTime timeNow = new DateTime();
            Response authnResponse = buildResponseForSigningWithoutAssertion(inResponseId, recipient, timeNow, issuerValue, issuerFormat);
            authnResponse.getEncryptedAssertions().add(buildEncrAssertionWithAuthnContextCnt(cnt, signCredential, encCredential, inResponseId, recipient, timeNow, acceptableTimeMin, loa, givenName, familyName, personIdentifier, dateOfBirth, issuerValue, issuerFormat, audienceUri));
            authnResponse.setSignature(signature);
            XMLObjectProviderRegistrySupport.getMarshallerFactory().getMarshaller(authnResponse).marshall(authnResponse);
            Signer.signObject(signature);
            return authnResponse;
